Dentro de los 2 test realizados y solicitados por endpoint, para este endpoint se obtuve un error en el segundo test, puesto a que se espera que el formulario no permita colocar alternativas repetidas
