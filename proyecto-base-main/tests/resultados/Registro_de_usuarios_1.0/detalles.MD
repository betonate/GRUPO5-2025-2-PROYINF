Dentro de los 2 test realizados y solicitados por endpoint, para este endpoint se obtuve un error en el segundo test, puesto a que se deberia rechazar la solicitud en caso de ingresar un email valido.
